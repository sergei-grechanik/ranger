...
C<w3mimgdisplay>, C<ueberzug>, C<mpv>, C<iTerm2>, C<kitty>, C<terminology>,
C<urxvt> or C<tupimage> for image previews
...
Tupimage is a script that uses a modified version of the kitty graphics
protocol. Supports tmux and ssh. Only works in a fork of kitty and a fork of st.
